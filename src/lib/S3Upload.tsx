  ...
  for (var i = 0; i < files.length; i++) {
    ...
    this.preprocess(
      ...
      function(processedFile) {
        ...
        result.push(this.uploadFile(processedFile, this.params));
        return result;
      }.bind(this)
    );
  }
...
S3Upload.prototype.executeOnSignedUrl = function(file, callback, params) {
...
S3Upload.prototype.uploadFile = function(file, params) {
  var uploadToS3Callback = this.uploadToS3.bind(this, file);

  if (this.getSignedUrl)
    return this.getSignedUrl(file, uploadToS3Callback, params);
  return this.executeOnSignedUrl(file, uploadToS3Callback, params);
};
